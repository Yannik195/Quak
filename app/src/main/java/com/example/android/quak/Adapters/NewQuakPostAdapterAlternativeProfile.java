...
public class NewQuakPostAdapterAlternativeProfile extends ArrayAdapter<QuakPostProfile> {
    ...
    public NewQuakPostAdapterAlternativeProfile(@NonNull Context context, int resource, @NonNull List<QuakPostProfile> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final QuakPostProfile currentQuakPost = getItem(position);
        ...
        profilePictureImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                */
                View image = view.findViewById(R.id.pp_image_view);
                ExpandAnimation expandAnimation = new ExpandAnimation(image, 1000);
